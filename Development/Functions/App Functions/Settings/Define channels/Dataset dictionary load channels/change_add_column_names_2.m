function [old_column_names_list,new_column_names_list] = change_add_column_names_2(old_column_names_list,new_column_names_list,old_column_names)
...
% old_column_names = cell_line_data.Properties.VariableNames;
